$(document).ready(function(){
    $(".menu").each(function(i, v){
        ...
        $(".menu-item", $menu).each(function(i){
        ...
        $(".menu-toggle-button", $menu).mousedown(function(){
            TweenMax.to($(".menu-toggle-icon", $menu),0.1,{
                scale:0.65
            })
        })
        ...
        $(".menu-toggle-button", $menu).on("mousedown",pressHandler);
        $(".menu-toggle-button", $menu).on("touchstart",function(event){
