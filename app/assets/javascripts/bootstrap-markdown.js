...
!function ($) {
    ...
    Markdown.prototype = {
        ...
        , showPreview: function () {
            ...
            var $clmPreview = $('button[data-handler="bootstrap-markdown-cmdPreview"]', this.$editor);
            $clmPreview.hide();
            $clmPreview.before('<svg version="1.1" class="preview-loader" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26px" height="26px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"> <path fill="#000" d="M25.251,6.461c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615V6.461z"> <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatCount="indefinite"/></path></svg>');
            $.ajax('/previews', {
                url: '/previews',
        ...
        , hidePreview: function () {
            ...
            $('button[data-handler="bootstrap-markdown-cmdPreview"]', this.$editor).html("<span class=\"glyphicon glyphicon-eye-open\"></span> Prévisualiser");
            // Back to the editor
            this.$textarea.show();
            this.__setListener();
